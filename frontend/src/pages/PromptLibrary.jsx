  ...
  return (
    <div className="mos-panel p-5" data-testid={`prompt-card-${p.key}`}>
      <div className="flex items-start justify-between mb-2">
        <div>
          <div className="font-display font-bold text-sm text-[#0A2540]">{p.key}</div>
      ...
      <textarea
        ...
        className="w-full font-mono text-xs bg-slate-50 border border-slate-300 rounded-sm p-2 focus:border-[#0A2540] focus:ring-1 focus:ring-[#0A2540] outline-none"
      ...
      <div className="mt-2 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            className="bg-[#0A2540] text-white hover:bg-[#021122] text-xs h-8 rounded-sm"
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0">
      <header className="bg-white border-b border-slate-300 px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex border-b border-slate-300 -mb-3" data-testid="prompt-tabs">
          <button
            data-testid="tab-global"
            onClick={() => setTab("global")}
            className={`px-4 pb-2 text-sm font-semibold ${tab === "global" ? "border-b-2 border-[#0A2540] text-[#0A2540]" : "text-slate-500 hover:text-slate-700"}`}
          >
          ...
          <button
            ...
            className={`px-4 pb-2 text-sm font-semibold ${tab === "project" ? "border-b-2 border-[#0A2540] text-[#0A2540]" : "text-slate-500 hover:text-slate-700"}`}
          >
            Project ({proj.length})
          </button>
        </div>
