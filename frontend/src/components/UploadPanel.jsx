...
export default function UploadPanel({ projectId, onKBUpdated, onCollapse }) {
  ...
  return (
    <div className="h-full flex flex-col gap-4 overflow-y-auto mos-scroll pr-1">
      {/* Source ingest */}
      ...
      {/* File list */}
      <div className="mos-panel flex flex-col">
        <div className="px-4 py-2.5 border-b border-[#E6E6E6] mos-label">Uploaded</div>
        <div className="max-h-60 overflow-y-auto mos-scroll">
          {files.length === 0 ? (
